...
void Buzzer_On(uint16_t Volume, uint16_t Duration)
{
	__HAL_TIM_SetCompare(BUZZER_TIM, TIM_CHANNEL_1, Volume);
	HAL_Delay(Duration);
	__HAL_TIM_SetCompare(BUZZER_TIM, TIM_CHANNEL_1, 0);
}
...
void Buzzer_Choose_Note(uint16_t Note)
{
	switch(Note)
	{
		...
		case Low_Do:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,3821);
			break;
		}
		case Low_Do_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,3608);
			break;
		}
		case Low_Re:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,3404);
			break;
		}
		case Low_Re_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,3214);
			break;
		}
		case Low_Mi:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,3033);
			break;
		}
		case Low_Fa:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2863);
			break;
		}	
		case Low_Fa_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2703);
			break;
		}	
		case Low_So:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2550);
			break;
		}	
		case Low_So_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2408);
			break;
		}	
		case Low_La:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2272);
			break;
		}
		case Low_La_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2145);
			break;
		}	
		case Low_Ti:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,2024);
			break;
		}
		case Mid_Do:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1910);
			break;
		}	
		case Mid_Do_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1804);
			break;
		}	
		case Mid_Re:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1702);
			break;
		}	
		case Mid_Re_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1607);
			break;
		}	
		case Mid_Mi:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1516);
			break;
		}	
		case Mid_Fa:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1431);
			break;
		}	
		case Mid_Fa_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1351);
			break;
		}	
		case Mid_So:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1275);
			break;
		}	
		case Mid_So_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1204);
			break;
		}
		case Mid_La:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1135);
			break;
		}	
		case Mid_La_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1073);
			break;
		}	
		case Mid_Ti:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,1011);
			break;
		}
		case High_Do:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,955);
			break;
		}	
		case High_Do_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,902);
			break;
		}	
		case High_Re:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,850);
			break;
		}	
		case High_Re_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,804);
			break;
		}	
		case High_Mi:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,757);
			break;
		}	
		case High_Fa:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,715);
			break;
		}	
		case High_Fa_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,676);
			break;
		}	
		case High_So:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,637);
			break;
		}	
		case High_So_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,602);
			break;
		}	
		case High_La:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,567);
			break;
		}	
		case High_La_N:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,536);
			break;
		}	
		case High_Ti:
		{
			__HAL_TIM_SET_AUTORELOAD(BUZZER_TIM,505);
			break;
		}
	}
}
